...
/////////////////////////////////////////////////////////////////////////////////////////////
CApplWindow::CApplWindow(HINSTANCE hInstance):m_hInstance(hInstance),
...
/////////////////////////////////////////////////////////////////////////////////////////////
bool CApplWindow::CreateApplWindow(const char *name, int width, int height, bool fullscreen)
{
    int idx = 0;
...
/////////////////////////////////////////////////////////////////////////////////////////////
bool CApplWindow::SetupGraphicApi(IGraphicApi *gapi, GAPICREATIONINFO &info)
{
    info.hWindow = m_hWnd;
...
/////////////////////////////////////////////////////////////////////////////////////////////
LRESULT CALLBACK CApplWindow::ApplWinProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
/////////////////////////////////////////////////////////////////////////////////////////////
void CApplWindow::ProcessMessages()
{
    MSG msg;
    bool process = true;
    CApplication *app = CApplication::GetSingleton();
...
/////////////////////////////////////////////////////////////////////////////////////////////
// Registering Application Window Class
BOOL CApplWindow::RegisterApplWindowClass()
{
    WNDCLASSEX wndclass;
...
/////////////////////////////////////////////////////////////////////////////////////////////
// Creating Application Window
HWND CApplWindow::CreateApplWindow()
{
