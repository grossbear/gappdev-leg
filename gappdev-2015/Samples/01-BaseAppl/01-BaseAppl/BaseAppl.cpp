...
CApplication *CreateApplication(const char *cmdline)
{
	...
	CBaseAppl::CreateSingleton();
	return CBaseAppl::GetSingleton();
}

/////////////////////////////////////////////////////////////////////////////////////////////
void CBaseAppl::CreateSingleton()
{
	if(!m_pAppl) 
	{
		m_pAppl = new CBaseAppl();
	}
}
/////////////////////////////////////////////////////////////////////////////////////////////
CBaseAppl::CBaseAppl():CApplication()
{
...
/////////////////////////////////////////////////////////////////////////////////////////////
void CBaseAppl::SetSize(int width, int height)
{
    if(height <= 0)
        height = 1;
    m_width = width;
...
/////////////////////////////////////////////////////////////////////////////////////////////
void CBaseAppl::KeyDown(unsigned int key)
{
	int xn = 0;
}

/////////////////////////////////////////////////////////////////////////////////////////////
void CBaseAppl::KeyUp(unsigned int key)
{
	int xn = 0;
}
...
/////////////////////////////////////////////////////////////////////////////////////////////
bool CBaseAppl::StartAppl(CApplWindow *pApplWnd)
{
    /*
